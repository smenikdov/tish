...
export default function MeasureListFilters() {
    ...
    const form = useForm({
        ...
        initialState: {
            ...
            measureId: psp.integer(searchParams.get('measureId')),
        ...
        <div>
            <Form action={handleApplyFilters} className="mb-md">
                <Row gapX="md" gapY="sm">
                    <Col md={3}>
                        <FormItem label="ID">
                            <InputNumber {...form.register('measureId')} min={0} />
                        </FormItem>
                    </Col>
                    <Col md={3}>
