...
export const metadata: Metadata = {
    title: 'Админпанель | Редактирование единицы измерения',
    ...
    return (
        <main>
            <Container className="my-lg">
                <Breadcrumbs
                    pageNames={{ [`${ props.params.id }`]: 'Редактирование единицы измерения' }}
                    className="mb-lg"
                />
                <MeasureEditForm isEdit measureId={Number(props.params.id)} />
            </Container>
        </main>
    );
}
